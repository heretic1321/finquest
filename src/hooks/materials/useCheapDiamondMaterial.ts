...
export const useCheapDiamondMaterial = (props: TUseNonStoneMaterialType) => {
  ...
  const [
    ...
    color: props.color ?? '#bebebe',
    emissiveColor: props.emissiveColor ?? '#ffffff',
    emissiveIntensity: props.emissiveIntensity ?? 0,
    envMapIntensity: props.envMapIntensity ?? 7.52,
    ...
    toneMapped: props.toneMapped ?? false,
  })

  // useControls(
  //   'Cheap Diamond Material ' + props.debugDisplayName,
  //   () => ({
  //     transparent: {
