/* eslint-disable */
/**
 * This file is an exact port of original react-three-fiber Html component
 * just with a few modifications to make it work with occlusion.
 * To find the change in the file, search for "ATTENTION" and you will find it.
 */
...
//Added ts-ignore to the following line because the types are not fully compatible with the original library
//@ts-ignore
export interface HtmlProps
  ...
  //ATTENTION : This is a change from the original version of this library
  //onOcclude is now a function that has void return type
...
export const Html = React.forwardRef(
  (
    ...
    React.useLayoutEffect(() => {
      ...
      // Intentionally empty function, used to force a rerender
    ...
    useFrame((gl) => {
      if (group.current) {
        ...
        if (
          ...
          // ATTENTION - This is the change made to the original code
          //Original code -
