...
interface InventoryConsoleAdaptiveScreenProps {
...
const InventoryConsoleAdaptiveScreen: React.FC<
  InventoryConsoleAdaptiveScreenProps
> = ({
...
export default InventoryConsoleAdaptiveScreen
